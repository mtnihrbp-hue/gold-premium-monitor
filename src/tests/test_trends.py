...
def test_3day_trend_up():
    """Arrow up when premium rises over 3 days."""
...
def test_3day_trend_down():
    """Arrow down when premium falls over 3 days."""
...
def test_3day_trend_exact_threshold():
...
def test_3day_trend_insufficient_data():
...
if __name__ == "__main__":
    test_3day_trend_up()
    test_3day_trend_down()
    test_3day_trend_flat()
    test_3day_trend_exact_threshold()
    test_3day_trend_insufficient_data()
